<main>
    ...
    <form class="form form--add-lot container form--invalid <?= $classname; ?>" action="add.php" method="post"
        ...
        <div class="form__item form__item--wide <?= $classname; ?>">
            ...
            <textarea id="lot_description" name="lot_description"
                      placeholder="Напишите описание лота"><?= $lot["lot_description"] ?></textarea>
        ...
        <div class="form__container-three">
            ...
            <div class="form__item <?= $classname; ?>">
                ...
                <input class="form__input-date" id="end_date" type="text" name="end_date"
