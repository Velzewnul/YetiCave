...
<form class="form container <?= $classname; ?>" action="signup.php" method="post" autocomplete="off" enctype="multipart/form-data"> <!-- form
    --invalid -->
    ...
    <div class="form__item <?= $classname; ?>">
        ...
        <textarea id="contact_info" name="contact_info" placeholder="Напишите как с вами связаться"><?= $user['contact_info']; ?></textarea>
